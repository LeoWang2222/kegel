const CACHE='kegel-v5.2.4';
const ASSETS=['./','./index.html','./styles.css','./refinements.css','./app.js','./peach.svg','./favicon.svg','./manifest.webmanifest','./apple-touch-icon.png','./icon-192.png','./icon-512.png'];
